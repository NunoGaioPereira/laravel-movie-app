...
<body class="font-sans bg-gray-900 text-white">
    <nav class="border-b border-gray-800">
        <div class="container mx-auto px-4 flex flex-col md:flex-row items-centet justify-between px-4 py-6">
            ...
            <div class="flex flex-colr md:flex-row items-center">
                <div class="relative mt-3 md:mt-0">
                    ...
                    <div class="absolute top-0"><!-- ADD SEARCH ICON --></div>
                </div>
                <div class="md:ml-4 mt-3 md:mt-0">
                    <a href="">
                    <img src="/imgs/avatar.jpg" class="rounded-full w-8 h-8" alt=""></a>
                </div>
            </div>
        </div>
    </nav>
